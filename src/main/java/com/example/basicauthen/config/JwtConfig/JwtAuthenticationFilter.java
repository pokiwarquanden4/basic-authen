...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (request.getRequestURI().equalsIgnoreCase(EnableTokenPath.reportUser)
                || request.getRequestURI().equalsIgnoreCase(EnableTokenPath.report)
                || request.getRequestURI().equalsIgnoreCase(EnableTokenPath.createToken)
        ){
